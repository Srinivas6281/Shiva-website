    ...
    <div className='about' ref={ref}  data-aos={props['data-aos']}>
        <div className="about-me">
            ...
            <div className="con1">
               ...
               <p> <img src={arrow} alt="" /> Whether it's cooling issue in your fridge, a noisy washing machine, or an unresponsive TV, you can contact me to get it fixed with professional precision and care.</p><br />
               <p><img src={arrow} alt="" />  Need help with your appliance? Just reach out-I'm here to help!</p>
            </div>
        </div>
    </div>
  )
